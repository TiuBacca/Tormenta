...
public interface PersonagemService {
	...
	List<PersonagemResponse> buscaListaPersonagemByFiltro(PersonagemRequest request) throws Exception;

	void excluirPersonagem(PersonagemRequest request) throws Exception;

	void salvarPersonagem(PersonagemRequest request) throws RegistroNaoEncontradoException;
