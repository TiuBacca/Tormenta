...
public interface ClasseRepository extends JpaRepository<Classe, Long> {
	...
	@Query(" select new com.baccarin.tormenta.vo.classe.ClasseResponse (c.id, c.nome) from Classe c where c.nome like :nome")
	public List<ClasseResponse> buscarListaClassesByNome(@Param("nome") String nome);
}
